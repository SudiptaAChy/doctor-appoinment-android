...
class AppointmentListFragment : Fragment() {
    ...
    private fun initAdapter() {
        val appointments = listOf(
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Available"),
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Booked"),
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Filled Up"),
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Available"),
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Booked"),
            AppointmentItemModel(time = "9:00 AM", totalSlot = 10, availableSlot = 2, slotStatus = "Filled Up"),
        )
